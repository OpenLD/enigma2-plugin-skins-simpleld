...
class SimpleWeatherSetup(Screen, ConfigListScreen):
	...
	def initConfigList(self):
		...
		self.list.append(getConfigListEntry(_("Get your local Weather ID on https://openweathermap.org/")))
		self.list.append(getConfigListEntry(_("SimpleWeather APIKEY"), config.plugins.SimpleWeather.apikey , _("Get your local SimpleWeather APIKEY from https://openweathermap.org/")))
		self.list.append(getConfigListEntry(_(" ")))
